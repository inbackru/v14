...
class SmartSearch:
    ...
    def fallback_analysis(self, query):
        ...
        room_patterns = {
            'студия': ['студ', 'studio'],
            '1': ['1-к', '1к', '1 к', 'однок', 'одноком', '1 комн', '1комн'],
            '2': ['2-к', '2к', '2 к', 'двух', 'двушка', '2 комн', '2комн'],
            '3': ['3-к', '3к', '3 к', 'трех', 'трешка', '3 комн', '3комн'],
        ...
        print(f"DEBUG: Fallback analysis for '{query}' -> {result}")
        return result
